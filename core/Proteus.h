...
enum masks {mMode=0x080000, isNormed=0x100000, asDesc=0x200000, toExec=0x400000, sizeIndef=0x80, mListPos=0xff000000, goSize=16};
...
#define SetPureTypeForm(pInf,Ty,Fo) SetBits((pInf).flags, (mFormat+tType), (Ty+Fo))
